...
class FriendsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.rv_friend_remove, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        icRemoveFriend.setOnClickListener {
            removeFriendByService(holder.itemView.context, data.id, holder.adapterPosition)
        }
    }
    ...
    private fun removeFriendByService(context: Context, friendId: Int, position: Int) {
        sessionViewModel.userData?.apply {
            userService.deleteFriend(accessToken, friendId).processAsync { code, body, throwable ->
                when (code) {
